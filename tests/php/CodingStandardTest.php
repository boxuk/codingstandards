...
class CodingStandardTest extends PHPUnit_Framework_TestCase {
    ...
    public function testScalarParametersRequireAParamAnnotation() {
        $this->assertSniffFails( 'ScalarParamWithoutParamAnnotation' );
    }
    ...
    public function testIntParamAnnotationIsAllowed() {
        $this->assertSniffPasses( 'IntParam' );
    }
